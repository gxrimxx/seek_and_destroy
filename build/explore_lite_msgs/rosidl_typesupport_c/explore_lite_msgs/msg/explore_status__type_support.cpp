...
static const _ExploreStatus_type_support_symbol_names_t _ExploreStatus_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, explore_lite_msgs, msg, ExploreStatus)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, explore_lite_msgs, msg, ExploreStatus)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, explore_lite_msgs, msg, ExploreStatus)() {
  return &::explore_lite_msgs::msg::rosidl_typesupport_c::ExploreStatus_message_type_support_handle;
}
