...
class Navigator(Node):
    ...
    def on_cmd(self, msg: String):
        ...
        elif data == 'CLEAR_COSTMAPS':
            self.get_logger().info('Clearing costmaps post-sweep')
            os.system('ros2 service call /clear_entirely_costmaps '
    ...
    def _send_nav_goal(self, x: float, y: float, yaw: float = 0.0):
        ...
        if self._active_goal_handle is not None:
            self.get_logger().info('Cancelling previous goal before new one.')
